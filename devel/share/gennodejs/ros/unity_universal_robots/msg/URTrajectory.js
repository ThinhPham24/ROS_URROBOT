...
// (in-package unity_universal_robots.msg)
...
class URTrajectory {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new URTrajectory(null);
  ...
  static datatype() {
    ...
    return 'unity_universal_robots/URTrajectory';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new URTrajectory(null);
